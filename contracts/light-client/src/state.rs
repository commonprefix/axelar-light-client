...
use types::lightclient::{Hash, Message, PublicKeyWrapper};
...
pub const CURRENT_COMMITTEE_KEYS: Map<u64, PublicKeyWrapper> = Map::new("current_committee_keys");
pub const NEXT_COMMITTEE_KEYS: Map<u64, PublicKeyWrapper> = Map::new("next_committee_keys");
